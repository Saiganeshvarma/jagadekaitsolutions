...
const Products = () => {
  ...
  return (
    <section id="products" className="py-8 sm:py-12 bg-gradient-to-br from-gray-50 via-white to-orange-50 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Products We Deploy</h2>
